...
const orderSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getOrderByNumber.fulfilled,
...
export const orderRequestSelector = (state: RootState) => state.orderSlice.orderRequest
export const orderModalDataSelector = (state: RootState) => state.orderSlice.orderModalData
// --------------------------------
