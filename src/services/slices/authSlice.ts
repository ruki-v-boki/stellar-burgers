...
export const isAuthCheckedSelector = (state: RootState) => state.authSlice.isAuthChecked;
export const isLoadingAuthSelector = (state: RootState) => state.authSlice.isLoading;
